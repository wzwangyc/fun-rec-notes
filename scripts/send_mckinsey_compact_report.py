...
msg['Subject'] = Header('[麦肯锡估值报告 - 紧凑专业版] 中兵红箭 (000519.SZ) - 目标价 21 元', 'utf-8')
...
附件为麦肯锡全球总部估值与战略咨询团队出具的《中兵红箭 (000519.SZ) 标准估值策略报告（紧凑专业版）》。
...
# 附加 PDF 报告
pdf_path = r"C:\Users\28916\.openclaw\workspace\scripts\麦肯锡估值报告_中兵红箭_紧凑专业版.pdf"
filename = "麦肯锡估值报告_中兵红箭_紧凑专业版.pdf"
...
print('SUCCESS: Compact McKinsey report sent!')
