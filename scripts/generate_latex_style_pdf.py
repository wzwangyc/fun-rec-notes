...
# 创建 PDF 文档
output_path = r"C:\Users\28916\.openclaw\workspace\scripts\中兵红箭投资价值分析报告_LaTeX 风格.pdf"
...
# 标题
content.append(Paragraph("EQUITY RESEARCH", subtitle_style))
content.append(Spacer(1, 0.5*cm))
content.append(Paragraph("中兵红箭 (000519.SZ)", title_style))
...
# 分析师信息
content.append(Paragraph(f"编制：Leo 智能投研", normal_style))
...
# 构建 PDF
doc.build(content)
print(f"LaTeX-style PDF report generated: {output_path}")
